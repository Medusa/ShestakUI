...
L_WELCOME_LINE_3 = "Hinweis: Diese Version von ShestakUI (|cff00FFFFOzEdit 1.4.2|r|cffFFFF00) wird von Oz von Pozzo dell'Eternità bearbeitet.|r" -- Goooooooooogle translated
