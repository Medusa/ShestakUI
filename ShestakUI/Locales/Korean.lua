...
L_WELCOME_LINE_3 = "참고: ShestakUI (|cff00FFFFOzEdit 1.4.7|r|cffFFFF00)이 버전은 Pozzo dell'Eternità의 오즈 (가) 수정되었습니다.|r" -- Goooooooooogle translated
...
L_SLASHCMD_HELP = {
	...
	"/farmmode - Increase the size of the minimap (옵션이 활성화 된 경우).", -- Goooooooooogle translated
