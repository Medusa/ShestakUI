...
L_TOOLTIP_ACH_NOT_EAT = "Not Eaten"
L_TOOLTIP_ACH_EAT = "Eaten"
L_TOOLTIP_ACH_NOT_DRINK = "Not Consumed"
L_TOOLTIP_ACH_DRINK = "Consumed"
L_TOOLTIP_ACH_NOT_EQUIP = "Not Equipped"
L_TOOLTIP_ACH_EQUIP = "Equipped"
...
L_MISC_UI_OUTDATED = "Sua verso do ShestakUI est desatualizada. Voc pode baixar a verso mais recente www.shestak.org"
...
L_CHAT_COME_ONLINE = "se |cff298F00conectou|r."
L_CHAT_GONE_OFFLINE = "se |cffff0000desconectou|r."
...
L_WELCOME_LINE_3 = "Nota: esta versão do ShestakUI (|cff00FFFFOzEdit 1.4.2|r|cffFFFF00) é editado por Oz de Pozzo dell'Eternità.|r" -- Goooooooooogle translated
...
L_SLASHCMD_HELP = {
	...
	"/farmmode - Increase the size of the minimap (se a opção estiver ativada).", -- Goooooooooogle translated
