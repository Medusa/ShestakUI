...
L_WELCOME_LINE_3 = "Примечание: данная версия ShestakUI (|cff00FFFFOzEdit 1.3.7|r|cffFFFF00) изменена Oz из Pozzo dell'Eternità.|r" -- Thanks to Shestak for translation
