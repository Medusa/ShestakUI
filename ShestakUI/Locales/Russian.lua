...
L_WELCOME_LINE_3 = "Примечание: данная версия ShestakUI (|cff00FFFFOzEdit 1.3.8|r|cffFFFF00) изменена Oz из Pozzo dell'Eternità.|r" -- Thanks to Shestak for translation
...
L_SLASHCMD_HELP = {
	...
	"/farmmode - Увеличивает миникарту (если опция включена).", -- Goooooooooogle translated
