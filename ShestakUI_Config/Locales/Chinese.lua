...
L_GUI_MINIMAP_FARM_MODE = "启用/farmmode的选项" -- Goooooooooogle translated
...
L_GUI_UF_CLASS_ICONS_PORTRAIT_HEIGHT = "纵向高度的类图标" -- Goooooooooogle translated
L_GUI_UF_CLASS_ICONS_PORTRAIT_WIDTH = "纵向宽度的类图标" -- Goooooooooogle translated
L_GUI_UF_ALTERNATIVE_PORTRAITS = "启用对健康酒吧的画像（你需要禁用的选项，播放/目标画像）" -- Goooooooooogle translated
L_GUI_UF_CLASS_ICONS_PORTRAITS = "类图标播放器/目标（你需要禁用该选项，播放/目标肖像的肖像）" -- Goooooooooogle translated
L_GUI_UF_PLAYER_NAME_LEVEL = "显示名称和级别的球员" -- Goooooooooogle translated
