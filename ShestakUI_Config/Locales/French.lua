...
L_GUI_AUTOMATION_AUCTION_HOUSE_UNDERCUT = "Inférieurs de 1% des concours de la maison de vente aux enchères" -- Goooooooooogle translated
...
L_GUI_CHAT_TOP_EDIT_BOX = "Zone d'édition sur le dessus" -- Goooooooooogle translated
...
L_GUI_UF_CLASS_ICONS_PORTRAIT_HEIGHT = "Icônes de classe portrait hauteur" -- Goooooooooogle translated
...
L_GUI_UF_RAID_PORTRAITS = "Activer portraits sur les cadres de raid" -- Goooooooooogle translated
...
L_GUI_STATS_BAGS = "Sacs" -- Goooooooooogle translated
L_GUI_STATS_CLASS_STATS = "Statistiques de la classe" -- Goooooooooogle translated
L_GUI_STATS_TALENTS = "Talents" -- Goooooooooogle translated
