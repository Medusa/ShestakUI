...
L_GUI_MISC_AUCTION_HOUSE_UNDERCUT = "Um 1% unterboten die Wettbewerbe der Auktionshäuser" -- Goooooooooogle translated
...
L_GUI_AUTOMATION_AUTO_ROLE = "AAutomatisch die eigene Rolle wählen"
...
L_GUI_UF_CLASS_ICONS_PORTRAIT_HEIGHT = "Klasse icons Hochformathöhe" -- Goooooooooogle translated
...
L_GUI_UF_RAID_PORTRAITS = "Aktivieren Porträts auf RAID-Frames" -- Goooooooooogle translated
...
L_GUI_STATS_CLASS_STATS = "Stats der Klasse" -- Goooooooooogle translated
L_GUI_STATS_TALENTS = "Talente" -- Goooooooooogle translated
