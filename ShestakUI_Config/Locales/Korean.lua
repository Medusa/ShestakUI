...
L_GUI_AUTOMATION_AUCTION_HOUSE_UNDERCUT = "1 %에 의해 약화 경매 하우스의 대회" -- Goooooooooogle translated
...
L_GUI_SKINS_TINY_DPS_LAYOUT_TWO = "Enable styling TinyDPS - 레이아웃 2" -- Goooooooooogle translated
...
L_GUI_CHAT_TOP_EDIT_BOX = "상단에 편집 상자" -- Goooooooooogle translated
...
L_GUI_MINIMAP_FARM_MODE = "옵션 /farmmode 사용" -- Goooooooooogle translated
...
L_GUI_UF_CLASS_ICONS_PORTRAIT_HEIGHT = "높이 세로 클래스 아이콘" -- Goooooooooogle translated
