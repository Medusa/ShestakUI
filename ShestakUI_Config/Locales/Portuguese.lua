...
L_GUI_AUTOMATION_AUCTION_HOUSE_UNDERCUT = "Minado por 1% das competições das casas de leilão" -- Goooooooooogle translated
...
L_GUI_SKINS_TINY_DPS_LAYOUT_TWO = "Enable styling TinyDPS - layout 2" -- Goooooooooogle translated
...
L_GUI_CHAT_TOP_EDIT_BOX = "Caixa de edição no topo" -- Goooooooooogle translated
...
L_GUI_MINIMAP_FARM_MODE = "Habilitar a opção /farmmode" -- Goooooooooogle translated
...
L_GUI_UF_CLASS_ICONS_PORTRAIT_HEIGHT = "Ícones de classe retrato altura" -- Goooooooooogle translated
L_GUI_UF_CLASS_ICONS_PORTRAIT_WIDTH = "Ícones de classe retrato largura" -- Goooooooooogle translated
...
L_GUI_UF_PLAYER_NAME_LEVEL = "Exibir o nome eo nível de jogador" -- Goooooooooogle translated
...
L_GUI_STATS_CLASS_STATS = "Estatísticas da classe" -- Goooooooooogle translated
