...
L_GUI_MINIMAP_FARM_MODE = "Включите опцию /farmmode" -- Goooooooooogle translated
...
L_GUI_UF_CLASS_ICONS_PORTRAIT_HEIGHT = "Класс иконки портрет высоте" -- Goooooooooogle translated
L_GUI_UF_CLASS_ICONS_PORTRAIT_WIDTH = "Класс иконки портрет ширина" -- Goooooooooogle translated
L_GUI_UF_ALTERNATIVE_PORTRAITS = "Включите портреты на здоровье баров (необходимо отключить опцию для игрока/цели портретов)" -- Goooooooooogle translated
L_GUI_UF_CLASS_ICONS_PORTRAITS = "Класс значок портреты для игрока / цели (необходимо отключить опцию для игрока / цели портреты)" -- Goooooooooogle translated
L_GUI_UF_PLAYER_NAME_LEVEL = "Отображение названия и уровня игрока" -- Goooooooooogle translated
...
L_GUI_UF_PLUGINS_VENGEANCE_BAR = "Индикатор отмщения"
...
L_GUI_UF_RAID_PORTRAITS = "Включить портреты на рейде кадров" -- Goooooooooogle translated
