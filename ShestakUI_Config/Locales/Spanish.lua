...
L_GUI_METER_ENABLE = "Habilitar el contador de daños (sólo para ShestakUI alDamageMeter)" -- Goooooooooogle translated
...
L_GUI_MINIMAP_FARM_MODE = "Habilitar la opción /farmmode" -- Goooooooooogle translated
...
L_GUI_UF_CLASS_ICONS_PORTRAIT_HEIGHT = "Iconos de la Clase retrato altura" -- Goooooooooogle translated
...
L_GUI_STATS_CLASS_STATS = "Estadísticas de la clase" -- Goooooooooogle translated
L_GUI_STATS_TALENTS = "Talentos" -- Goooooooooogle translated
