...
L_GUI_METER_MAXBARS = "酒吧的數量" -- Goooooooooogle translated
--]]
-- Tooltip options
L_GUI_TOOLTIP = "提示資訊"
...
L_GUI_UF_CLASS_ICONS_PORTRAIT_HEIGHT = "縱向高度的類圖標" -- Goooooooooogle translated
...
L_GUI_STATS_CLASS_STATS = "統計類" -- Goooooooooogle translated
